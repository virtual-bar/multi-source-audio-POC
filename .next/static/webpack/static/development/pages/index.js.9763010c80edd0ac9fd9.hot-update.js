...
var useAudio = function useAudio(_ref) {
  ...
  if (true) {
    ...
    var _useState = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(new AudioContext()),
        _audioCtx = _useState[0];

    var _useState2 = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(_audioCtx.createGain()),
...
var AudioTrack = function AudioTrack(_ref2) {
  ...
  if (true) {
    ...
    Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
      ...
      var track = _audioCtx2.createMediaElementSource(audioElement);

      track.connect(gainNode).connect(_audioCtx2.destination);
    }, []);
    Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
      var audioElement = getAudioElement();
...
//# sourceMappingURL=index.js.9763010c80edd0ac9fd9.hot-update.js.map